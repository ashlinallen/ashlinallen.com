...
(function () {
    ...
    var doc, win, planetEarthEl, ashEl, infoPanelEl, contactFormEl, isMobile, isAndroid,
        ...
        currentInterest, contactVisible, earthAnimating, mHelp, domHelp, screenHelperInst, 
        interestInst, skyInst, pageInst, contInst, infoPanelInst, earthInst, contactFormInst, 
        imagesInst, spritesInst;
    ...
    page.prototype = (function () {
        ...
        _animBrightness = function (showHide) {
            ...
            var _startFloat, _endFloat, _curFloat, _els, _anim, _nature,
                _sheri, _computers, _games, _shuttle, _satellite, _next;
    ...
    images.prototype = (function () {
        ...
        _init = function () {
            new Image("Rainier", "images/photos/rainier_1.jpg", "Rainier with a forboding cloud formation", "nature");
            new Image("Lake Margaret Trail", "images/photos/margaret_1.jpg", "Lake Margaret Trail", "nature");
            new Image("Snow Lake Trail", "images/photos/snow_1.jpg", "Snow Lake Trail", "nature");
            new Image("AutoLoop.us 2013", "images/portfolio/autoloop_1.jpg", "AutoLoop.us 2013. <a href='http://goo.gl/FNfBbY' target='_blank'>Wayback Archive</a>", "computers");
            new Image("AutoLoop Web Application", "images/portfolio/autoloop_2.jpg", "AutoLoop Web Application", "computers");
            new Image("AutoLoop Web Application", "images/portfolio/autoloop_3.jpg", "AutoLoop Web Application", "computers");
            new Image("AutoLoop Web Application", "images/portfolio/autoloop_4.jpg", "AutoLoop Web Application", "computers");
            new Image("AutoLoop Web Application", "images/portfolio/autoloop_5.jpg", "AutoLoop Web Application", "computers");
            new Image("AutoLoop Web Application", "images/portfolio/autoloop_6.jpg", "AutoLoop Web Application", "computers");
            new Image("AutoLoop Web Application", "images/portfolio/autoloop_7.jpg", "AutoLoop Web Application", "computers");
            new Image("AutoLoop Web Application", "images/portfolio/autoloop_8.jpg", "AutoLoop Web Application", "computers");
            new Image("MandalaySolutions.com 2011", "images/portfolio/mandalay_solutions_1.jpg", "MandalaySolutions.com 2011. <a href='http://goo.gl/NQ3pzY' target='_blank'>Wayback Archive</a>", "computers");
            new Image("MandalaySolutions.com Portfolio 2011", "images/portfolio/mandalay_solutions_2.jpg", "MandalaySolutions.com Portfolio 2011. <a href='http://goo.gl/PJcEz0' target='_blank'>Wayback Archive</a>", "computers");
            new Image("FantasticSamsFlorida.com 2011", "images/portfolio/fantastic_sams.jpg", "FantasticSamsFlorida.com 2011. <a href='http://goo.gl/pIYJUv' target='_blank'>Wayback Archive</a>", "computers");
            new Image("GlobalSyntheticIce.com 2011", "images/portfolio/global_synthetic_ice.jpg", "GlobalSyntheticIce.com 2011. <a href='http://goo.gl/128ll0' target='_blank'>Wayback Archive</a>", "computers");
        };
